"""
PDF Report Generator for SurakshaRx v5.0
...
class SurakshaRxPDF(FPDF):
    ...
    def header(self):
        ...
        self.set_xy(10, 5)
        self.cell(0, 12, "SurakshaRx | Pharmacogenomic Risk Report", ln=False)
    ...
    def footer(self):
        ...
        self.set_xy(10, 284)
        self.cell(0, 6, "DISCLAIMER: SurakshaRx is a research tool. Not for clinical use without validation. cpicpgx.org", ln=False)
        self.set_xy(-30, 284)
...
def generate_pdf_report(patient_id: str, all_outputs: List[Dict], parsed_vcf: Dict) -> bytes:
    ...
    pdf.multi_cell(0, 5.5,
        "This report has been generated by SurakshaRx v5.0, an AI-powered pharmacogenomics research tool "
